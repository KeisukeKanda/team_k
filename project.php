	...
	<section>
		...
		<div>
			...
			<form method="POST" action="project_insert.php" enctype="multipart/form-data">
				<div class="form">
					...
					<div id="dragDropArea">
						<div class="drag-drop-inside">
							<p class="drag-drop-info">写真を<br>ドラッグ＆ドロップ可能</p>
							<p>
								<input name="project_img" id="project_img" type="file" accept="image/*"
				...
				<div class="nav_btn">
					<input type="submit" value="作成" class="btn make-project" />
					<input type="reset" value="クリア" class="btn clear" />
				</div>
			</form>
		</div>
